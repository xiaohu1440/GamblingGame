...
namespace Gambling
{
    public class Global : Architecture<Global>
    {
        ...
        public static BindableProperty<int> chips = new BindableProperty<int>(0);
        public static BindableProperty<int> currentLevelSpinCount = new BindableProperty<int>(9);
        ...
        public static BindableProperty<int> coins=new BindableProperty<int>(20);
